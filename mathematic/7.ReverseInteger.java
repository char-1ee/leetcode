...
class Solution {
    ...
    public int reverse2(int x) {
        ...
        while (x != 0) {
            ...
            /*
             * Assume rev > 0:
             * 1. If temp = rev * 10 + pop overflow, then it must be that rev >=
             * Integer.MAX_VALUE / 10;
             * 2. If rev > Integer.MAX_VALUE / 10, then temp = rev * 10 + pop is guaranteed
             * to overflow.
             * 3.when rev == Integer.MAX_VALUE / 10, temp = rev * 10 + pop will ovreflow iff
             * pop > 7 (similar pop < -8).
             */
            rev = rev * 10 + pop;
        }
